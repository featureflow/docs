---
title: Managing key features on the featureflow console
...
Bob Featureflow is a feature management tool that provides you best practice tools to enable feature management on both the server and client side of your application.
