...
Navigate to the features list in any environment

Click the feature name to open the feature detail view
...
Click 'Save Feature Settings' to save your changes.
...
#### What's Next?
Want to tread lightly? You can roll out your features and variants gradually to a percentage of users: