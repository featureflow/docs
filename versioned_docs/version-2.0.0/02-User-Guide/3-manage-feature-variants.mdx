...
Once you've defined your variants, you can assign them to users through [targeting rules](/docs/targeting-features) or [gradual rollouts](/docs/gradual-rollouts).
...
- [Gradual rollouts](/docs/gradual-rollouts) — release variants to a percentage of users
- [Targeting features](/docs/targeting-features) — assign variants to specific users or segments