...
1. Navigate to the features list in any project
2. Click the feature name to open the feature detail view
3. Select the 'Settings' tab
4. Click 'Change Variants' button to show the variants if they are hidden
...
Examples may be:
* "v2" - To identify a particular version of a feature
...
:::caution
#### Modifying variants changes the variant in all environments
