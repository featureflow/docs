...
When evaluating a feature, you pass a user object with a unique ID and attributes (e.g., `tier`, `country`, `signup_date`). These attributes power [targeting rules](/docs/targeting-features) to control which users see which variants.
