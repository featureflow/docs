...
Your 'Server Environment Key' is available on the project page in featureflow.
...
You will see your new feature in the list, the 'lifecycle status' of the feature will be 'Created' - this means you have created a new feature but it has not been detected in any environment yet. The lifecycle status is a convenient way to identify where in the flag lifecycle your feature is.

* Register or evaluate the new feature in your SDK code (you can find the feature Key in the 'key' column or at the top of the feature detail tab)
...
In the feature detail overview, you can see the lifecycle status expanded, you can also view the status of the feature in each environment. You can quickly toggle your features on and off with these switches, or head to the 'Targeting' tab for finer control

![Status Icon](/img/2-0/quickstart-3-status-detail.png)
